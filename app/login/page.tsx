            ...
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="rounded-xl border border-white/10 bg-[#121215] p-8 shadow-2xl backdrop-blur-sm">
                    <div className="space-y-4">
                        <button
                            onClick={handleLogin}
                            className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-[#B11226] to-[#FF4D5A] px-8 py-3 font-bold text-white transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(255,77,90,0.6)]"
                        >
                            {/* Ícone GitHub SVG inline para garantir que apareça */}
