...
## 3. Diretrizes de Design (Design System Sage)

**Conceito:** Minimalismo de Alto Contraste (Startup Premium).

**Cores:**
- **Background:** #000000 (Preto Absoluto).
- **Foreground:** #FFFFFF ou #F8F8F8 (Branco/Off-white).
- **Acentos:** Escala de cinzas (zinc-800, zinc-900) para bordas e cards.

**Tipografia:** Família Inter (Sans-serif moderna).

**Geometria:**
- **Botões/Inputs:** rounded-md (Radius ~10px/0.625rem).
- **Cards:** rounded-xl.

**Componentes:** Uso estrito de componentes Shadcn/UI com override de variáveis CSS para garantir o tema "Super Dark".
...
- Hotfix: Aplicação de Design Tokens (Startup Template - Dark Mode).
- Hotfix: Correção de build Tailwind CSS v4 (substituição de @apply por CSS standard).
- Design: Ajustes finais do Sage System (Raio de borda corrigido, Tipografia Inter forçada, Textos de Login).
...
**Última Atualização:** 2026-01-15 às 15:36  
