...
// import { SplitText } from "gsap/SplitText"; // SplitText is a paid Club GSAP plugin. Using simplified animation for demo.
...
export default function InfiniteHero() {
    ...
    useGSAP(
        () => {
            ...
            // SplitText logic commented out because it requires a paid license.
            // Replaced with simple element animation.
            /*
            ...
            */
            ...
            // Initial states for fallback animation
            if (h1Ref.current) gsap.set(h1Ref.current, { opacity: 0, y: 24, filter: "blur(8px)" });
            if (pRef.current) gsap.set(pRef.current, { opacity: 0, y: 16, filter: "blur(6px)" });
            ...
            tl.to(bgRef.current, { filter: "blur(0px)", duration: 1.2 }, 0)
                .to(
                    h1Ref.current, // Animate the whole H1 instead of lines
                    {
                        opacity: 1,
                        y: 0,
                        filter: "blur(0px)",
                ...
                .to(
                    pRef.current, // Animate the whole P
                    {
                        opacity: 1,
                        y: 0,
                        filter: "blur(0px)",
